...
graphics.plot_joint_density(m.beta.trace()[:,2], m.gamma.trace())
pl.xticks(fontsize=16)
pl.yticks(fontsize=16)
pl.xlabel('$\\beta_2$', fontsize=24)
pl.ylabel('$\\gamma$', fontsize=24)
pl.savefig('../tex/ex4_a.png')

pl.figure(figsize=(12,9))
graphics.plot_joint_density(m.beta.trace()[:,0], m.beta.trace()[:,1])
pl.xticks(fontsize=16)
pl.yticks(fontsize=16)
