...
\title{The TFR-HDI controversy: an example Bayesian data analysis with PyMC}
...
\begin{abstract}
        ...
        \paragraph*{Methods:} I replicated part of an analyses of the relationship between Human Development Index (HDI) and Total Fertility Rate (TFR) using the PyMC package for Python.
...
\TFR_i &= \beta_0 + \beta_1 \HDI_i + \beta_2(\HDI_i - \gamma)^+ \ + \epsilon_i,\\
\epsilon_i &\sim N(0, \sigma^2),
\end{align*}
